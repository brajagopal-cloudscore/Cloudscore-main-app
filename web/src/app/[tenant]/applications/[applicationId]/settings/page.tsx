...
export default async function ApplicationSettingsPage({ params }: PageProps) {

  const applicationDetails = {
    workspace_name: "AI Model Governance Workspace",
    description: "Comprehensive workspace for managing AI model lifecycle, compliance, and governance across the organization.",
