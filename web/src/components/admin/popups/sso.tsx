    ...
    <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white w-[40%] 2xl:w-[30%] h-[600px] rounded-lg p-2 shadow-md z-50">
      <div className="flex w-full flex-col h-full">
        <div className="flex w-full justify-between my-1 2xl:my-4">
          <span className="flex font-bold text-base 2xl:text-lg mx-4">
            Add SSO
          </span>
        ...
        <div className="flex flex-col justify-around flex-1">
          ...
          <div className="flex w-full">
            <textarea
              placeholder="Active"
              className="flex p-1 2xl:p-3 h-24 2xl:h-32 w-full mx-5 rounded-lg border"
            />
          </div>
          ...
          <div className="flex w-full mx-4">
            <input
              placeholder="Active"
              type="checkbox"
              className="flex hover:border-[#6528F7] p-3 h-6 w-6 mx-2 rounded-lg border"
            />
            File Name
          </div>
        </div>
